...
export const billingSettings = pgTable("billing_settings", {
  ...
  ticketAckSubjectCustomer: text("ticket_ack_subject_customer").notNull().default("[Ticket #{{ticketNumber}}] {{subject}}"),
  ticketAckTemplateCustomer: text("ticket_ack_template_customer").notNull().default("Hello {{customerName}},\n\nThank you for contacting 911-DC Support. We have received your request and created ticket #{{ticketNumber}}.\n\nSubject: {{subject}}\n\nA support agent will review your request and respond shortly. You can view your ticket in the customer portal.\n\nThank you,\n911-DC Support"),
  ticketAckSubjectUnknown: text("ticket_ack_subject_unknown").notNull().default("[Ticket #{{ticketNumber}}] {{subject}}"),
  ticketAckTemplateUnknown: text("ticket_ack_template_unknown").notNull().default("Hello {{senderName}},\n\nThank you for contacting 911-DC Support. We have received your request and created ticket #{{ticketNumber}}.\n\nSubject: {{subject}}\n\nA support agent will review your request and respond shortly. You can reply to this email to add more information to your ticket.\n\nThank you,\n911-DC Support"),
